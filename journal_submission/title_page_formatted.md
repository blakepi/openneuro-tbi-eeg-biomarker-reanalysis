...
## Article type
Full-length original article / methodological report
...
## Keywords
mild traumatic brain injury; electroencephalography; post-concussive symptoms; event-related potentials; reproducibility; data leakage; OpenNeuro
...
Ethics: This study used publicly available, deidentified data from OpenNeuro and did not involve interaction with human participants or access to identifiable private information. The project was considered exempt from institutional review board review.
...
Highlights: 5, each no more than 85 characters including spaces

Figures: 7 main figures plus 4 supplementary figures

Tables: 5 main tables plus 6 supplementary tables
